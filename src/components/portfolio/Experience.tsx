...
const experience: TimelineItem[] = [
  ...
  },
  {
    ...
    points: [
      "Studying practical quantum algorithms and quantum programming fundamentals using Qiskit",
    ],
    type: "experience",
  },
];
...
const TimelineEntry = ({ item, index }: { item: TimelineItem; index: number }) => (
  ...
  >
    ...
    <div className="bg-card border border-border rounded-lg p-5">
      ...
      <p className="text-sm text-secondary mb-3">{item.org}</p>
...
const Experience = () => (
  <SectionWrapper id="experience" label="🗺️ My Journey">
    <div className="mb-12">
      <h3 className="font-heading text-lg text-foreground mb-6">Experience</h3>
    ...
    <div>
      <h3 className="font-heading text-lg text-foreground mb-6">Education</h3>
      <div className="relative">
